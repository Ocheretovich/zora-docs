...
We also recommend using a personal wallet to create your DAO. If you plan to use a [Safe multisig](https://safe.global/) to create a DAO, please reach out to us on [X (Twitter)](https://x.com/nounsbuilder) for support. 
